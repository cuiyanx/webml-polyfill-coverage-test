...
if (process.env.NODE_ENV === 'production') {
  ...
  if (process.env.NODE_ENV === 'coverage') {
    config.module = {rules: [{test: /\.js$/, use: {loader: 'babel-loader', options: {plugins: ['istanbul']}}, exclude: /node_modules/}]};
  } else {
    config.module = {rules: [{ test: /\.js$/, loader: 'babel-loader', exclude: /node_modules/ }]};
  }
